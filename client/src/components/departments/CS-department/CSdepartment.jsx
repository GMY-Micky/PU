    ...
    <div className="cs-department">
      ...
      <div className="person">
        ...
        <div className="person-info">
          <ul>
            ...
            <li className="item">
              Program Coordinator, BS Computer Science (New Campus)
            </li>
      ...
      <div className="person">
        ...
        <div className="person-info">
          <ul>
            <li className="item">Assistant Professor</li>
            <li className="item">
              Program Coordinator, M.Phil (CS) / M.Phil (RSGIS) / PhD (Old
              Campus)
            </li>
            <li className="item">
            ...
            <li className="item">
              BSc Agricultural Engineering, University of Agriculture,
              Faisalabad
            </li>
            <li className="item">
      ...
      <div className="person">
        ...
        <div className="person-info">
          <ul>
            <li className="item">Assistant Professor</li>
            <li className="item">
              Program Coordinator, BS Computer Science (Old Campus)
            </li>
            <li className="item">
              Ph.D. Computer Science (Research Work in Progress), PUCIT
            </li>
      ...
      <div className="person">
        ...
        <div className="person-info">
          <ul>
            ...
            <li className="item">
              MS Total Quality Management (Thesis in progress), PU
            </li>
            <li className="item">
              M.Sc Computer Science, PU, 2004 (Gold Medal)
            </li>
      ...
      <div className="person">
        ...
        <div className="person-info">
          <ul>
            <li className="item">Assistant Professor</li>
            <li className="item">
              Ph.D. Computer Science, Aberystwyth University, Aberytswyth, U.K,
              2019
            </li>
            <li className="item">MS in Computer Science,PU, 2014</li>
      ...
      <div className="person">
        ...
        <div className="person-info">
          <ul>
            <li className="item">Assistant Professor</li>
            <li className="item">
              Ph.D. Computer Science, University of Turin, Turin, Italy, 2015
            </li>
            <li className="item">
            ...
            <li className="item">
              BS Computer Science, University of the Punjab, Lahore, Pakistan,
              2004
            </li>
            <li className="item">
      ...
      <div className="person">
        ...
        <div className="person-info">
          <ul>
            <li className="item">Assistant Professor</li>
            <li className="item">PhD Computer Science</li>
      ...
      <div className="person">
        ...
        <div className="person-info">
          <ul>
            <li className="item">Assistant Professor</li>
            <li className="item">
              PhD Computer Science, University of Central Florida, USA, 2013
            </li>
            <li className="item">
              M.Sc Computer Science, University of Saarland, Germany
            </li>
      ...
      <div className="person">
        ...
        <div className="person-info">
          <ul>
            <li className="item">Assistant Professor</li>
            <li className="item">
              PhD Computer Science (course work completed) PUCIT, University of
              the Punjab, Lahore
            </li>
            <li className="item">MS Computer Science, UCP Lahore, 2008</li>
            <li className="item">
      ...
      <div className="person">
        ...
        <div className="person-info">
          <ul>
            <li className="item">Assistant Professor</li>
            <li className="item">
              PhD Mathematics (Applied Mathematics), PU, 2015
            </li>
            <li className="item">
              MPhil Applied Mathematics, UET Lahore, 2008
            </li>
            <li className="item">
      ...
      <div className="person">
        ...
        <div className="person-info">
          <ul>
            ...
            <li className="item">
              MPhil English Literature (Kinnaird College)
            </li>
            <li className="item">
              Masters English Literature (Kinnaird College) (Placed on
              Principal’s Honor List for securing 3.91 CGPA)
            </li>
            <li className="item">
              Bachelors (English Literature and Psychology) (1st Position) (Army
              Burn Hall College)
            </li>
            <li className="item">
